---
source-drive-id: 1vU1AhNr7KJ0zu_A_w-70Df7lo9lIYpm0PPHPq3D6mz8
source-cache: Medison__draft__1vU1AhNr.md
...
<!-- NOTE: Source uses "Senior" in the tagline — preserved verbatim as a historical version. Per voice rules, "Senior" is only acceptable in experience headers, not taglines, for future use. -->

# Michael Korenevsky

Senior Product Manager · B2B Platforms | 0 to 1 Delivery | Applied AI in Regulated Industries  •  050-9542810 · korm85@gmail.com · linkedin.com/in/michael-korenevsky

## Summary

Senior Product Manager with an engineering foundation, experienced in owning B2B products end-to-end in regulated, multi-persona enterprise environments. Have built products from prototype through MVP to scaled platform, coordinating UX, data, and engineering into one coherent release. Comfortable working directly with customers and business stakeholders to translate ambiguous needs into a prioritized backlog and clear product decisions. Hands-on experience shipping AI capabilities into production where accuracy, auditability, and access control are non-negotiable.
...
- Shipped a self-serve knowledge platform for sales, marketing, and operations to resolve technical questions independently, implemented as a RAG pipeline on a locally hosted LLM connected to live product documentation; measured adoption through reduction in ad-hoc requests to engineering and PM.
...
| Category | Skills |
|---|---|
| Product Leadership | End-to-end product ownership, 0 to 1 (Prototype to MVP to Platform), Roadmap and prioritization, Customer discovery, Stakeholder management, GTM execution |
| Applied AI / ML | AI features in production, RAG, Data curation (Label Studio), AI-augmented PM workflows (Claude Code, Figma Make); shipped products powered by Computer Vision |
...
| Tools | Figma / FigJam, Jira, Agile delivery, Release management, Cloud and on-premise software |

## AI Projects

- Runs a personal multi-agent development setup: OpenClaw as orchestrator coordinating OpenCode as the development agent via ACP (Agent Context Protocol), used to design and build applications end-to-end on home infrastructure.
